...
% 
% 1. Algotimos online e worst-case analysis, pessimismo e predições
% 
% 2. O problema do caching como caso de uso.
...
\vblue{Não tenho nenhuma preferência forte. Concordo que evitar estrangerismo é o ideal (o que nos penderia a usar paginação em geral), mas cache é um termo técnico já bem adotado, e não sei como escreveria ``acerto/falha de cache'' de outra maneira.}
